		...
		<>
			{isSignUp ? (
				<div>
					<div className="text-center pt-3 ">
						...
						<form>
							<div className="flex justify-center">
								<div className="flex justify-center xl:w-1/3 sm:w-1/2">
									<button
										type="button"
										name="action"
										value="google"
						...
						<div className="flex justify-center items-center p-2 ">
							<div className="flex items-center xl:w-1/3 sm:w-1/2">
					...
					<div className="flex justify-center">
						<div className="w-1/2 md:w-1/3 text-sm p-3 mb-3 text-gray-400">
